<template>
  <div class="content flex flex-col h-full w-screen overflow-x-hidden">
    ...
    <div class="intro h-full my-12 flex flex-col justify-between items-center">
      ...
      >
        <div v-scroll-reveal.reset.reset class="desc w-3/5">
          <div class="text-xl font-bold">
            Onderzoek <br />
            <div class="text-base font-thin italic">
              <p>
      ...
      >
        <div v-scroll-reveal.reset.reset class="desc w-3/5 flex-col">
          <div class="text-xl font-bold">
            Resultaat <br />
            <div class="text-base font-thin italic"></div>
          </div>
        </div>
        <div class="videoframe w-screen h-72 lg:h-96 flex flex-grow p-1/2">
          <iframe
        ...
        <a
          ...
          class="rounded-lg bg-quarternary text-primary opacity-80 h-full w-36 text-base text-center mb-8"
          >Ervaar op framer!</a
        >
