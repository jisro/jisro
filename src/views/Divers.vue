...
<br><br>
Zo kijkt de terminal onder meer welke knoppen belangrijk zijn voor de primaire actie, vergroot het formaat van kleine letters en vergroot het de lage contrasten. De interface van de app is aangepast aan deze behoeften van de doelgroep die de ontwerper in het begin betreedt.
<br> <br>
Dit beperkt de kracht van de ontwerper en maakt de applicatie gebruiksvriendelijker. Het resultaat is een helder ontwerp waaruit de bedoelingen duidelijker worden. Daarnaast wordt de gebruiker ook beperkt voor zijn gezondheid; in bijvoorbeeld de gebruikte tijd van de applicatie. 
             <br><br>
              <div class="text-base not-italic">
                <br />
                <!-- <a
